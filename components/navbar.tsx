      ...
      <nav className="container mx-auto flex  justify-between">
        ...
        <ul className="flex lg: mr-10">
          ...
          <li className="hoverable hover:bg-green-900 hover:text-white">
            ...
            <a
              href="#"
              className="relative block py-6 px-4 lg:p-6 text-sm lg:text-base font-bold hover:bg-green-900 hover:text-white"
            >
              Brands
            </a>
            <div
          ...
          <Link href="/about">
            <li className="relative block py-6 px-2 lg:p-6 text-sm lg:text-base font-bold hover:bg-green-900 hover:text-white cursor-pointer">
              About
            </li>
          </Link>
          {!user ? (
            <li
              className="relative block py-6 px-2 lg:p-6 text-sm lg:text-base font-bold hover:bg-green-900 hover:text-white cursor-pointer"
              onClick={login}
            >
              Login
            </li>
