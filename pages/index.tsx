  ...
  return (
    <>
      ...
      <main className = "h-full text-center">
        ...
        <div className = "absolute bottom-1/2 left-2/4 transform -translate-x-2/4 -translate-y-2/4 text-orange-main-page text-4xl font-bold laptop:text-6xl laptop:top-2/4">Explore Your Next Addition.</div>
        {newestSet.length !== 0 &&
