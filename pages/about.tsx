    ...
    <>
      ...
      <article className="w-3/4 flex flex-col justify-center mx-auto h-60v mb-5 laptop:h-40v">
        ...
        <p className="mb-2 text-lg laptop:text-xl desktop:text-2xl">
          Hype Kicks is a sneaker database where fellow sneakerheads can search
          for their favorite brands, and explore for their next addition to
          their collection. We make the best effort to provide users the most
          up-to-date sneaker data to keep up with trending and upcoming shoes.
          Come see all our selections here!
        </p>
        <p className="mb-2 text-lg laptop:text-xl desktop:text-2xl">
